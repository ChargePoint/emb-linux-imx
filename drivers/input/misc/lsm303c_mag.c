...
static struct device_attribute attributes[] = {
	__ATTR_LSM303C(pollrate_ms, 0666, attr_get_polling_rate_mag,
						attr_set_polling_rate_mag),
	__ATTR_LSM303C(full_scale, 0666, attr_get_range_mag, attr_set_range_mag),
	__ATTR_LSM303C(enable_device, 0666, attr_get_enable_mag, attr_set_enable_mag),
	__ATTR_LSM303C(x_y_opearative_mode, 0666, attr_get_xy_mode, attr_set_xy_mode),
	__ATTR_LSM303C(z_opearative_mode, 0666, attr_get_z_mode, attr_set_z_mode),
#ifdef DEBUG
