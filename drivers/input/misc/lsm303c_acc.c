...
static struct device_attribute attributes[] = {
	...
	__ATTR_LSM303C(pollrate_ms, 0666, attr_get_polling_rate, attr_set_polling_rate),
	__ATTR_LSM303C(range, 0666, attr_get_range, attr_set_range),
	__ATTR_LSM303C(enable_device, 0666, attr_get_enable, attr_set_enable),
	__ATTR_LSM303C(int1_config, 0664, attr_get_intconfig1, attr_set_intconfig1),
	__ATTR_LSM303C(int1_duration, 0664, attr_get_duration1, attr_set_duration1),
	__ATTR_LSM303C(int1_thresholdx, 0664, attr_get_threshx1, attr_set_threshx1),
	__ATTR_LSM303C(int1_thresholdy, 0664, attr_get_threshy1, attr_set_threshy1),
	__ATTR_LSM303C(int1_thresholdz, 0664, attr_get_threshz1, attr_set_threshz1),
	__ATTR_LSM303C(int1_source, 0444, attr_get_source1, NULL),
#ifdef LSM303C_DEBUG
	__ATTR_LSM303C(reg_value, 0600, attr_reg_get, attr_reg_set),
	__ATTR_LSM303C(reg_addr, 0200, NULL, attr_addr_set),
#endif
};
