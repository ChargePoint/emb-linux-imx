...
EXPORT_SYMBOL_GPL(rtk_led_serialModePortmask_set);
EXPORT_SYMBOL_GPL(rtk_led_serialMode_set);
EXPORT_SYMBOL_GPL(rtk_led_blinkRate_set);
EXPORT_SYMBOL_GPL(rtk_led_operation_set);
EXPORT_SYMBOL_GPL(rtk_led_enable_set);
EXPORT_SYMBOL_GPL(rtk_led_groupConfig_set);
EXPORT_SYMBOL_GPL(rtk_led_OutputEnable_set);
MODULE_LICENSE("GPL");
